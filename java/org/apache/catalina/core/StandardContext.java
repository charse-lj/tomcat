...
public class StandardContext extends ContainerBase
    ...
    public void setWebappVersion(String webappVersion) {
        ...
        support.firePropertyChange("webappVersion",null,webappVersion);
    }
    ...
    public void setDocBase(String docBase) {
        support.firePropertyChange("docBase",this.docBase,docBase);
    ...
    public void setPath(String path) {
        ...
        support.firePropertyChange("path", null,this.path );
        support.firePropertyChange("encodedPath", null,this.encodedPath );
        if (getName() == null) {
            setName(this.path);
        }
    }
    ...
    public void setWorkDir(String workDir) {
        ...
        support.firePropertyChange("workDir",this.workDir,workDir);
    ...
    public void addChild(Container child) {
        SelfPrinter.invoke(this,"addChild");
        // Global JspServlet
    ...
    private void postWorkDirectory() {
        ...
        SelfPrinter.printLocalParam(this,"postWorkDirectory","workDir",workDir);
