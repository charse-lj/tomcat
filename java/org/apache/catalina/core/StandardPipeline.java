...
public class StandardPipeline extends LifecycleBase implements Pipeline {
    ...
    public void setContainer(Container container) {
        ...
        support.firePropertyChange("container",null,container);
    }
    ...
    public void setBasic(Valve valve) {
        ...
        support.firePropertyChange("basic",oldBasic,valve);
        // 新增的valve和basic相同,直接返回
        if (oldBasic == valve)
            return;

        // Stop the old component if necessary
        if (oldBasic != null) {
            // 当前pipeline是启动状态,并且之前的basic是生命周期组件
    ...
    public void addValve(Valve valve) {
        ...
        // Start the new component if necessary
        // 当前pipeline 是启动状态时,新添加进来的valve也需要启动,否则忽略
        ...
        /*
         *  注 v1:next --> 表示 v1对象的next属性
         *
         *  当 first == null,新增的valve = v1
         *  first <-- v1:next <--basic
         *            /
         *        current
         *
         *  当 first !=null,新增的valve = v2
         *  first <-- v1:next <--v2:next <-- basic
         *            /         /
         *        current   current
         *
         *  当first !=null,新增valve = v3
         *  first <-- v1:next <-- v2:next <-- v3:next <-- basic
         */
        if (first == null) {
            first = valve;
            valve.setNext(basic);
