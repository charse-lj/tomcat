...
public class StandardService extends LifecycleMBeanBase implements Service {
     ...
     */
    // 这个方法，Digester解析server.xml后，会通过反射调用。
    @Override
    ...
    public void addExecutor(Executor ex) {
        ...
        support.firePropertyChange("executor",null,ex);
    }
    ...
    protected void startInternal() throws LifecycleException {
        ...
        // 启动Connector，而Connector又会对ProtocolHandler进行初始化，开启应用端口的监听
        synchronized (connectorsLock) {
    ...
    protected void stopInternal() throws LifecycleException {
        SelfPrinter.invoke(this,"stopInternal");
        ...
        SelfPrinter.end(this,"stopInternal");
    }
     ...
     */
    // 调用预先启动初始化。 这用于允许connectors绑定在Unix操作环境限制的端口。
    @Override
    protected void initInternal() throws LifecycleException {
        ...
        // Initialize any Executors（没进这个if）
    ...
    protected void destroyInternal() throws LifecycleException {
        SelfPrinter.invoke(this,"destroyInternal");
        ...
        SelfPrinter.end(this,"destroyInternal");
    }
