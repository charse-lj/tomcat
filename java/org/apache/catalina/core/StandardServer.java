...
public final class StandardServer extends LifecycleMBeanBase implements Server {
    ...
    public StandardServer() {
        ...
        addPropertyChangeListener(new SelfDefinePropertyChangeListener());
    }
    ...
    public void setPort(int port) {
        this.port = port;
        support.firePropertyChange("port", null, port);
    }
    ...
    public void setPortOffset(int portOffset) {
        ...
        support.firePropertyChange("portOffset", null, portOffset);
    }
    ...
    public void setAddress(String address) {
        ...
        support.firePropertyChange("address", null, address);
    }
    ...
    public void setShutdown(String shutdown) {
        ...
        support.firePropertyChange("shutdown", null, shutdown);
    }
    ...
    public void setUtilityThreads(int utilityThreads) {
        ...
        support.firePropertyChange("utilityThreads",
                null,
                utilityThreads);
    }


    // 重新配置ScheduledThreadPoolExecutor，如果没初始化，则new一个。
    private synchronized void reconfigureUtilityExecutor(int threads) {
        ...
        if (utilityExecutor != null) {
            // ScheduledThreadPoolExecutor不需要设置MaximumPoolSize（因为二叉堆是无界的，没机会创建非核心线程），只有CorePoolSize是有用的。
    ...
    public void setCatalinaBase(File catalinaBase) {
        ...
        support.firePropertyChange("catalinaBase",
                null,
                catalinaBase);
    }
    ...
    public void setCatalinaHome(File catalinaHome) {
        ...
        support.firePropertyChange("catalinaHome",
                null,
                catalinaHome);
    }
    ...
    protected void startInternal() throws LifecycleException {
        ...
        fireLifecycleEvent(CONFIGURE_START_EVENT, null);  // 触发生命周期事件
        setState(LifecycleState.STARTING);  // 设置为【启动中】
    ...
    protected void initInternal() throws LifecycleException {
        ...
        // Initialize utility executor （初始化ScheduledThreadPoolExecutor）
        reconfigureUtilityExecutor(getUtilityThreadsInternal(utilityThreads));
        // 注册组件
        ...
        // Initialize our defined Services  (初始化我们定义的服务)
        for (Service service : services) {
            // 这里默认会初始化一个StandardService
            service.init();
        }
        SelfPrinter.end(this, "initInternal");
    }
