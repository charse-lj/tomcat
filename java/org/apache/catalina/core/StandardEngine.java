...
/**
 * 容器的层次结构:Engine、Host、Context、Wrapper 和 Servlet
 * Context 表示 web 应用程序、wrapper 表示 servlet、context 有多个 wrapper，host 也有多个 context
...
public class StandardEngine extends ContainerBase implements Engine {
    ...
    public void setService(Service service) {
        ...
        support.firePropertyChange("service",this.service,service);
    }
    ...
    public void addChild(Container child) {
        ...
        support.firePropertyChange("children",this.children,child);
    }
    ...
    protected void initInternal() throws LifecycleException {
        ...
        // 在尝试启动一个领域之前，请确保存在Realm。如有必要，这将创建默认的NullRealm。
