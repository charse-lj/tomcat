...
public class Connector extends LifecycleMBeanBase {
    ...
    public boolean setProperty(String name, String value) {
        ...
        support.firePropertyChange("protocolHandler",
                protocolHandler,"{\""+name+"\":\""+value+"\"}");
     ...
     *
     * @param methods Comma separated list of HTTP method names  【逗号分隔的HTTP方法名称列表】
     */
    // HTTP方法应允许body参数解析set列表。 默认为POST 。
    ...
    protected void initInternal() throws LifecycleException {
        ...
        if (service != null) {
            // 将StandardServer中的ScheduledExecutorService，传递给Http11NioProtocol的成员endpoint
