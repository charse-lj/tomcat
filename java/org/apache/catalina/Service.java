...
/**
 * Service是一组共享一个单一的Container来处理他们的传入请求的一个或多个Connectors的。
 * 这种布局允许，例如，非SSL和SSL connector共享相同数量的网络应用。
 *
 * 一个给定的JVM可以包含任意数量的Service实例; 然而，它们是完全相互独立的，并只共享system class path上的基本JVM设施和classes。
 */
