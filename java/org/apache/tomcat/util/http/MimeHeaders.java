...
public class MimeHeaders {
     ...
     */
    // 向header添加部分构造的字段。该字段的名称或值尚未初始化。
    // 创建一个MimeHeaderField，并塞到MimeHeaders的MimeHeaderField[]中
    ...
    public MessageBytes addValue(byte b[], int startN, int len) {
        ...
        // 返回value的引用，拿到引用的，调用MessageBytes.setBytes设置value
        return mhf.getValue();
    }
