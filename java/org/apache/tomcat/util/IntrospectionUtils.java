...
public final class IntrospectionUtils {
     ...
     * @param o The object to set a property on 将要设置属性的对象.
     * @param name The property name 将要设置的属性的name
     * @param value The property value 将要设置的属性的value
     * @return <code>true</code> if operation was successful
     */
    public static boolean setProperty(Object o, String name, String value) {
        SelfPrinter.reflectSetProperty(o,name,value);
