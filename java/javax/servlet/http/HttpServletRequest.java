 ...
 *         请求路径                                路径元素
 *                                          ContextPath: /catalog
 * /catalog/lawn/index.html                 ServletPath: /lawn
 *                                          PathInfo: /index.html
 *
 *                                          ContextPath: /catalog
 * /catalog/garden/implements/              ServletPath: /garden
 *                                          PathInfo:  /implements/
 *
 *                                          ContextPath: /catalog
 * /catalog/help/feedback.jsp               ServletPath: /help/feedback.jsp
 *                                          PathInfo:  null
 */
public interface HttpServletRequest extends ServletRequest {
     ...
     *   获得请求中的cookie的一个数组。这些cookie是从客户端发送到服务器端的客户端发出的每个请求上的数据
     */
     ...
     *
     *         请求路径的一部分，不属于Context Path或Servlet Path
     */
